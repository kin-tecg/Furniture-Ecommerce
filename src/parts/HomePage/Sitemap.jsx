                    ...
                    <div className="flex flex-wrap -mx-4 justify-center">
                        ...
                        <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                            ...
                            <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                                ...
                                <li>
                                    <Link to="/contactus" className="hover:underline py-1 block">
                                        contactus
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                            ...
                            <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                                ...
                                <li>
                                    <Link to="/privacy" className="hover:underline py-1 block">
                                        Privacy Policy
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/developers" className="hover:underline py-1 block">
                                        For developers
                                    </Link>
                                </li>
                            </ul>
